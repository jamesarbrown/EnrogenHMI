...
public class transformer extends ComponentConstructorBaseComponent {
    ...
    public transformer(String name) {
        ...
        parameterMap.put("ComponentType", "transformer");
    ...
    //Overload
    public transformer(HashMap parameters) {
        setParameterTypes();
    ...
    // Drawing
    ////////////////////////////////////////////////////////////////////////////
    public void drawTransformer(Graphics g) {
        g.setColor(components.BUS_BAR_COLOR);
        g.drawOval(5, 0, 30, 30);
